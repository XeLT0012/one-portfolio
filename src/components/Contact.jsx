        ...
        className='w-full h-screen bg-gradient-to-b from-black to-gray-800 p-4 text-white'>
            ...
            <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto'>
                <div className='pb-8'>
                    ...
                    <p className='py-6'>Submit the form in below to get in touch  with me</p>
                </div>
            </div>

            <div className='flex justify-center items-center'>
                <form action="https://getform.io/f/6dBD3Xa7" method="POST" className='flex flex-col w-full md:w-1/2'>
                    <input type="text" 
                    name="name" 
